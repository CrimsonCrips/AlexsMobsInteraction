...
public class AInteractionTagRegistry {
    ...
    public static final TagKey<EntityType<?>> ANACONDA_KILL = registerEntityTag("anaconda_kill");

    public static final TagKey<EntityType<?>> BIGCATFISHCANNOTEAT = registerEntityTag("bigcatfish_cannotkill");

    public static final TagKey<EntityType<?>> WARPED_KILL = registerEntityTag("warped_kill");

    public static final TagKey<EntityType<?>> SNOW_KILL = registerEntityTag("snow_kill");
    ...
    public static final TagKey<EntityType<?>> MIMIC_KILL = registerEntityTag("mimic_kill");
    ...
    public static final TagKey<EntityType<?>> KOMODODRAGON_KILL = registerEntityTag("komododragon_kill");
    public static final TagKey<EntityType<?>> FROSTSTALKER_KILL = registerEntityTag("froststalker_kill");

    public static final TagKey<EntityType<?>> HERBIVORE = registerEntityTag("herbivore");
    ...
    public static final TagKey<EntityType<?>> CROCODILE_KILL = registerEntityTag("crocodile_kill");
    public static final TagKey<EntityType<?>> BALD_EAGLE_KILL = registerEntityTag("bald_eagle_kill");
    public static final TagKey<EntityType<?>> CACHALOT_WHALE_KILL = registerEntityTag("cachalot_whale_kill_chance");
    ...
    public static final TagKey<EntityType<?>> CAIMAN_KILL = registerEntityTag("caiman_kill");
    ...
    public static final TagKey<EntityType<?>> MANTIS_KILL = registerEntityTag("mantis_kill");
    ...
    public static final TagKey<EntityType<?>> TIGER_KILL = registerEntityTag("tiger_kill");

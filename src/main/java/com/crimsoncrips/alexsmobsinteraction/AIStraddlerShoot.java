...
public class AIStraddlerShoot extends Goal {
    ...
    public AIStraddlerShoot(EntityStraddler mob, double moveSpeedAmpIn, int attackCooldownIn, float maxAttackDistanceIn) {
        this.entity = mob;

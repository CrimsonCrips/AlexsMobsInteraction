...
public abstract class AIFrogRendering extends MobRenderer<Frog, FrogModel<Frog>> {


    public AIFrogRendering(EntityRendererProvider.Context pContext, FrogModel<Frog> pModel, float pShadowRadius) {

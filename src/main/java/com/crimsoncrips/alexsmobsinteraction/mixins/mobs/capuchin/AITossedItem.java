...
public abstract class AITossedItem extends ThrowableItemProjectile {
    ...
    public AITossedItem(EntityType<? extends ThrowableItemProjectile> pEntityType, Level pLevel) {
    ...
    protected Item getDefaultItem() {
        if (AInteractionConfig.capuchinbomb && AInteractionConfig.goofymode) items = Items.TNT;

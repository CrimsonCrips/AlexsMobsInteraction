...
public class AMILayerOverlays extends RenderLayer<EntityLaviathan, ModelLaviathan> {
    ...
    public AMILayerOverlays(RenderLayerParent<EntityLaviathan, ModelLaviathan> pRenderer) {
        super(pRenderer);
    }

...
public class AIPocketSand extends Item {

    @Shadow @Final public static Predicate<ItemStack> IS_SAND;

    public AIPocketSand(Item.Properties properties) {
        super(properties);
    }
    ...
    public InteractionResultHolder<ItemStack> use(Level worldIn, Player livingEntityIn, InteractionHand handIn) {
        ...
        if (!worldIn.isClientSide && (!ammo.isEmpty() || AInteractionConfig.sandnoammo)) {
            ...
            if (!AInteractionConfig.sandnoammo) ammo.shrink(1);

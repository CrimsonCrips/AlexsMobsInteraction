...
public class AMILootTables {
	...
	//Book Lootables
	public static final ResourceLocation STABILIZER_ADDITION = register("glm/stabilizer_addition");
	public static final ResourceLocation LIGHTWEIGHT_ADDITION = register("glm/lightweight_addition");
	public static final ResourceLocation STRETCHY_ADDITION = register("glm/stretchy_addition");
	public static final ResourceLocation ROLLING_ADDITION = register("glm/rolling_addition");

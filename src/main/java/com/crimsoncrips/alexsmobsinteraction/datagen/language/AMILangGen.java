...
public class AMILangGen extends AMILangProvider {
	...
	protected void addTranslations() {
		...
		this.addAdvancementDesc("acclimate","Acclamation", "Make an inactive shreaker active with a skreecher soul");
		...
		this.addAdvancementDesc("combustible","Trials of Flames", "Pour oil in yourself and step into something hot");
		...
		this.addAdvancementDesc("devil_fish","Devil's Fishing", "Fish up a Devil's Hole Pupfish within its chunk");
		this.addAdvancementDesc("hasty_carving","Hasty Carving", "Carve a portal while on the effects of haste");
		this.addAdvancementDesc("obsidian_extract","Obsidian Mining", "Extract obsidian on a solidified laviathan");
		...
		this.addEffect("skreeching","Skreeching","Causes a Warden to spawn when the effect wares off");

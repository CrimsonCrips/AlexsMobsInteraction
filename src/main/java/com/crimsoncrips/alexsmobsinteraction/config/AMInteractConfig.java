...
;
    ...
    public AMInteractConfig(final ForgeConfigSpec.Builder builder) {
        ...
        this.straddlershots = buildInt(builder, "straddlershots", " ", AMInteractionConfig.straddlershots, 0, Integer.MAX_VALUE, "Amount of shots a Straddler has before reloading to fire again (0 Disables this feature)");

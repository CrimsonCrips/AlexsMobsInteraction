...
public class AMIItemRegistry {
    ...
    public static final RegistryObject<Item> BOOK_SHATTERED = DEF_REG.register("ami_book_shattered", () -> new AMIBookShattered(new Item.Properties().stacksTo(1).rarity(Rarity.EPIC)));
}